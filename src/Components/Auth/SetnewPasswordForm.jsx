...
const SetnewPasswordForm = () => {
    ...
    useEffect(() => {
       ...
       confirmeNewPassword !== '' & confirmeNewPassword === newPasword? setIsMatch(true):setIsMatch(false);
    ...
    async function handleSubmit(e) {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/setNewPassword`,{
                method:'PUT',
                headers:{
      ...
      <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl mx-auto ">
        ...
        className="card-body w-full  mt-4">
          <div className="form-control">
            ...
            type='password'
            placeholder="Nueva contraseña" className="input input-bordered newPassword"  />
          </div>
          <div className="form-control">
            <label className="label">
